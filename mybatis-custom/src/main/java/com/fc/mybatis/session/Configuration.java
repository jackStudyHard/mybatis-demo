package com.fc.mybatis.session;

import com.fc.mybatis.TestMybatis;
import com.fc.mybatis.annotation.Entity;
import com.fc.mybatis.annotation.Select;
import com.fc.mybatis.binding.MapperRegistry;
import com.fc.mybatis.executor.CachingExecutor;
import com.fc.mybatis.executor.Executor;
import com.fc.mybatis.executor.SimpleExecutor;
import com.fc.mybatis.plugin.Interceptor;
import com.fc.mybatis.plugin.InterceptorChain;
...
public class Configuration {
    ...
    private void scanPackage(String mapperPath) {
        ...
        for (String className : classPaths) {
            ...
            className = className.replace(classPath,"").replaceAll(File.separator,".").replace(".class","");
            Class<?> clazz = null;
            try {
